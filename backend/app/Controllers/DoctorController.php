...
class DoctorController extends BaseController
{
    ...
    public function apiIndex()
    {
        ...
        $formatted = array_map(function ($doctor) {
            return [
                'id' => $doctor['BacSiID'] ?? null,
                'name' => $doctor['HoTen'] ?? 'Bác sĩ',
                'specialty' => $doctor['TenChuyenKhoa'] ?? 'Chuyên khoa',
                'experience' => $doctor['KinhNghiem'] ?? 'Đang cập nhật',
                'description' => $doctor['MoTa'] ?? 'Chưa có mô tả.'
            ];
        }, $doctors);
