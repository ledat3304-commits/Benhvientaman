...
abstract class BaseController
{
     ...
     * Cần có /public để form gửi request đúng địa chỉ trên Apache/XAMPP
     */
    protected string $baseUrl = '/BenhvienTamAn/public';
    ...
    protected function redirect(string $url): void
{
    ...
    $cleanUrl = str_replace(['/BenhvienTamAn/public', '/BenhvienTamAn'], '', $url);
